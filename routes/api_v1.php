...
Route::group(['middleware' => ["throttle:20,1","api_logger"]], function(){
    ...
    Route::get("/countries/{country}",'CountryController@findById')->name("countries.show");

    Route::get("/countries/{country}/states",'StateController@getStates')->name("states.index");

    Route::get("/countries/{country}/states/{state}",'StateController@findById')->name("states.show");
