                ...
                <div class="sidebar">
                    ...
                    <div class="widget pl-4">
                        ...
                        <ul class="list-unstyled mb-40 categories">
                            ...
                            <li><a href="#president-by-country" class="scroll-div">Presidents by country and name</a>
                            </li>
                ...
                <div class="col-lg-8 col-md-12  ml-auto px-0">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>Specifies number of items to return. Returns paginated data. Example
                                                <div class="code"><span class="url"> {{env('APP_URL')}}
                                                        /api/v1/countries?size_from=10000&size_to=100000&per_page=5</span></div>
                    ...
                    <div id="country-slim" class="content ">
                        ...
                        <div class="inner">
                            ...
                            <p>In the case were you just want the minimal country information to reduce the amount of
                                data
                    ...
                    <div id="president-by-country" class="content ">
                        <h4 class="title text-dark">Presidents by Country and Name - <span
                                    class="text-success">GET</span></h4>
                        <div class="inner">
                    ...
                    <div id="covid19-by-deaths" class="content ">
                        <h4 class="title text-dark">Covid 19 cases by death range only - <span
                                    class="text-success">GET</span></h4>
                    ...
                    <div id="state-by-country-state" class="content ">
                        <h4 class="title text-dark">State by Country Name and State Name - <span class="text-success">GET</span>
                        </h4>
